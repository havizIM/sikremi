        ...
        <section class="panel">
            <div class="panel-body">
                <div class="small-chart pull-right">
                    <i class="fa fa-search fa-4x text-info"></i>
                </div>

                <div class="h4 text-weight-bold mb-none" id="count_aplikasi">...</div>
                <p class="text-xs text-muted mb-none">Total Aplikasi Terverifikasi</p>
            </div>
        </section>
    </div>
</div>
